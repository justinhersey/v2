...
<?php include("../includes/header.php"); ?>
	<div class="hobie-cat-company">
		...
		<div class="row">
			<div class="col-12 columns">
				<p class="lead-in"><span class="brand-emphasis">Hobie Cat<sup>&reg;</sup> Company.</span> I was hired by Hobie Cat Company to redesign their U.S. consumer website. My role included design, front-end development, photography art direction and content curation.</p>
			</div>
		</div>
	</div>
	...
	<div class="row block-grid work">
		...
		--><div class="col-6 columns">
			<img src="../build/images/hrail-seating.jpg" alt="H-Rail and Seating Configuration" />
		</div><!--
		--><div class="col-6 columns">
			<img src="../build/images/pa-17-screenshot.jpg" alt="PA17 Screenshot" />
		</div>
	</div>
	<div class="row">
		<div class="col-12 columns">
			<p><a class="project-url" href="http://www.hobiecat.com/"><span class="icon-16-plus"></span>Visit hobiecat.com</a></p>
		</div>
	</div>
