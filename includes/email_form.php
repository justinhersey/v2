<div class="col-12">
	...
	<form id="form1" class="email-form" name="form1" accept-charset="UTF-8" autocomplete="off" enctype="multipart/form-data" method="post" novalidate action="https://justinhersey.wufoo.com/forms/zfr4bdj0h75w7t/#public">
		...
		<input id="Field2" name="Field2" type="email" spellcheck="false" value="" maxlength="255" tabindex="2" placeholder="Your email address" />
		<input id="saveForm" name="saveForm" class="button" type="submit" value="Send question" />
		<div class="hide">
			<label for="comment">Do Not Fill This Out</label>
			<textarea name="comment" id="comment" rows="1" cols="1"></textarea>
			<input type="hidden" id="idstamp" name="idstamp" value="eIRPhdWeM083Uxa3AIZN3JB8zGVtoWwRhsvv4uwCovA=" />
		</div>
	</form>
</div>